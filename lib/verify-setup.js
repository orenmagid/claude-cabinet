 ...
 *
 * Dispatched from cli.js's install pipeline when the `verify` module
 * is selected (the previous omega-setup.js shared this pattern before
 * removal in v0.27.0). Idempotent: skips if the matching-version
 * tarball is already present.
 *
